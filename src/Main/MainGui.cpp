...
const char sBanner[] = "\xc2\xa9 iCAD laboratory, KAIST 2015-2017\n";

#if defined(_MSC_VER)
void InitMiniDumpWriter(const std::string&);
#endif

#if defined (ED_OS_LINUX) || defined(ED_OS_BSD)
...
int main( int argc, char ** argv )
{
    ...
    App::Application::Config()["MaintainerUrl"] = "http://icad.kaist.ac.kr";

    // set the banner (for logging and console)
    App::Application::Config()["CopyrightInfo"] = sBanner;
    App::Application::Config()["AppIcon"] = "edisondesigner.png";	// use image file located at bin folder
    ...
    try {
        // Init phase ===========================================================
        // sets the default run mode for ED, starts with gui if not overridden in InitConfig...
