...
// "  #     #   #    #     #    #     # #   #  ##  ##  ##\n" \
// "  #     #   #### ####   ### #     # ####   ##  ##  ##\n\n" ;
const char sBanner[] = "(c) Youngki Kim, Chiho Noh | iCAD Lab. in KAIST 2014-2018\n";
...
int main( int argc, char ** argv )
{
    ...
    App::Application::Config()["ExeName"] = "EdisonDesigner";
    App::Application::Config()["ExeVendor"] = "iCAD Lab.";
    App::Application::Config()["AppDataSkipVendor"] = "true";
    App::Application::Config()["MaintainerUrl"] = "http://icad.kaist.ac.kr";

    // set the banner (for logging and console)
    App::Application::Config()["CopyrightInfo"] = sBanner;
    App::Application::Config()["AppIcon"] = "edisondesigner.png";
