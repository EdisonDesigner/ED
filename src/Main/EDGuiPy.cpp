...
static PyObject *
EDGui_showMainWindow(PyObject * /*self*/, PyObject *args)
{
...
static PyObject *
EDGui_exec_loop(PyObject * /*self*/, PyObject *args)
{
...
static PyObject *
EDGui_setupWithoutGUI(PyObject * /*self*/, PyObject *args)
{
    if (!PyArg_ParseTuple(args, ""))
        return NULL;
    ...
    if (!Gui::Application::Instance) {
        ...
        PyErr_SetString(PyExc_RuntimeError, "EdisonDesignerGui already initialized");
        return 0;
    }
...
static PyObject *
EDGui_embedToWindow(PyObject * /*self*/, PyObject *args)
{
    char* pointer;
    ...
    if (!widget) {
        PyErr_SetString(Base::BaseExceptionEdisonDesignerError, "No main window");
        return 0;
    }
    ...
    if (!Gui::MainWindow::getInstance()) {
        ...
        if (!init) {
            try {
                ...
                PyErr_Format(Base::BaseExceptionEdisonDesignerError, "Error in EDGuiInit.py: %s\n", e.what());
                return 0;
            }
            init = true;
        }
...
PyMODINIT_FUNC initEDGui()
{
    try {
        Base::Interpreter().loadModule("ED");
        App::Application::Config()["AppIcon"] = "edisondesigner";
        App::Application::Config()["SplashScreen"] = "edsplash";
        App::Application::Config()["CopyrightInfo"] = "\xc2\xa9 iCAD laboratory, KAIST 2015-2017\n";
        Gui::Application::initApplication();
        Py_InitModule("EDGui", EDGui_methods);
    }
    catch (const Base::Exception& e) {
