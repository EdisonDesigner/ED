...
int main( int argc, char ** argv )
{
    ...
    try {
        // Init phase ===========================================================
        // sets the default run mode for ED, starts with command prompt if not overridden in InitConfig...
    ...
    // Destruction phase ===========================================================
    Console().Log("EdisonDesigner terminating...\n");
    ...
    Console().Log("EdisonDesigner completely terminated\n");
