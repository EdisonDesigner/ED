...
PyObject*  DocumentPy::copyObject(PyObject *args)
{
    ...
    if (copy) {
        ...
        throw Py::Exception(Base::BaseExceptionEdisonDesignerError,str);
    }
}
...
PyObject*  DocumentPy::findObjects(PyObject *args)
{
    ...
    if (!type.isDerivedFrom(App::DocumentObject::getClassTypeId())) {
        PyErr_Format(Base::BaseExceptionEdisonDesignerError, "Type '%s' does not inherit from 'App::DocumentObject'", sType);
        return NULL;
    }
