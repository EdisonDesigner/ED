...
void Application::initApplication(void)
{
	...
	new ScriptProducer("EdisonDesignerInit", EdisonDesignerInit);
	new ScriptProducer("EdisonDesignerTest", EdisonDesignerTest);
    ...
    try {
        ...
        Interpreter().runString(Base::ScriptFactory().ProduceScript("EdisonDesignerInit"));
