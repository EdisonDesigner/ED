...
This is besides the Application class the most important class in ED
It contains all the data of the opened, saved or newly created ED Document.
...
As the document is the main data structure of ED we have to take a close
...
The ED document handles the dependencies of its DocumentObjects with
...
void Document::Save (Base::Writer &writer) const
{
    ...
    << "<!--" << endl
    << " ED Document, see http://www.freecadweb.org for more information..." << endl
    << "-->" << endl;
