...
PyObject * FeaturePythonPyT<FeaturePyT>::staticCallback_addProperty (PyObject *self, PyObject *args)
{
    ...
    try {
        ...
        str += ")";
        e.ReportException();
        PyErr_SetString(Base::BaseExceptionEDError,str.c_str());
        return NULL;
    }
...
PyObject *FeaturePythonPyT<FeaturePyT>::_getattr(char *attr)
{
    ...
    catch(const Base::Exception& e) {// catch the ED exceptions
        std::string str;
        str += "ED exception thrown (";
        str += e.what();
        str += ")";
...
PyObject*  FeaturePythonPyT<FeaturePyT>::addProperty(PyObject *args)
{
    ...
    if (!prop) {
        ...
        throw Py::Exception(Base::BaseExceptionEDError,str.str());
    }
