...
#define MAX 2024
/*
ED_OS_LINUX: This is dangerous. How about PY_EXCEPT_MAX?
*/
...
//#ifdef ED_OS_LINUX /* cannot convert `const char *' to `char *' in assignment */
...
PP_Run_Command_Line(const char *prompt)
{
    ...
    if (prompt != NULL)
#if defined (ED_OS_LINUX) || defined(ED_OS_CYGWIN) || defined(ED_OS_MACOSX)
