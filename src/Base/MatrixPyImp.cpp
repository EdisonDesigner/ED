...
int MatrixPy::PyInit(PyObject* args, PyObject* /*kwd*/)
{
	...
	PyErr_SetString(Base::BaseExceptionEdisonDesignerError, "matrix or up to 16 floats expected");
    return -1;
}
...
PyObject* MatrixPy::multiply(PyObject * args)
{
	...
	PyErr_SetString(Base::BaseExceptionEdisonDesignerError, "either vector or matrix expected");
    return 0;
}
...
PyObject* MatrixPy::invert(PyObject * args)
{
    ...
    PY_TRY {
        if (fabs(getMatrixPtr()->determinant()) > DBL_EPSILON)
            ...
            PyErr_SetString(Base::BaseExceptionEdisonDesignerError, "Cannot invert singular matrix");
            return 0;
        }
    }
    PY_CATCH;
