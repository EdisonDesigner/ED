...
BaseExport extern PyObject* BaseExceptionEdisonDesignerError;
#define PY_FCERROR (Base::BaseExceptionEdisonDesignerError ? \
BaseExceptionEdisonDesignerError : PyExc_RuntimeError)
 ...
 *   }catch(...)                                                        \
 *   {                                                                 \
 * 	 	Py_Error(Base::BaseExceptionEdisonDesignerError,"Unknown C++ exception");          \
...
#  define PY_CATCH catch(Base::Exception &e)                        \
    {                                                               \
        ...
        str += ")";                                                 \
        e.ReportException();                                        \
		Py_Error(Base::BaseExceptionEdisonDesignerError,str.c_str());      \
    }                                                               \
    ...
    {                                                               \
        Py_Error(Base::BaseExceptionEdisonDesignerError,e);                \
    }                                                               \
    catch(...)                                                      \
    {                                                               \
        Py_Error(Base::BaseExceptionEdisonDesignerError,"Unknown C++ exception"); \
