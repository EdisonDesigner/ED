 ...
 *  very important because nearly all important classes in ED
...
BaseExport extern PyObject* BaseExceptionEDError;
#define PY_FCERROR (Base::BaseExceptionEDError ? \
 BaseExceptionEDError : PyExc_RuntimeError)
 ...
 *   }catch(...)                                                        \
 *   {                                                                 \
 * 	 	Py_Error(Base::BaseExceptionEDError,"Unknown C++ exception");          \
 ...
 * }
 * \endcode
 * this catch maps all of the ED standard exception to a clear output for the 
 * Python exception.
 * @see PYMETHODEDEF
 * @see PyObjectBase
 */
...
#  define PY_CATCH catch(Base::Exception &e)                        \
    {                                                               \
        ...
        str += ")";                                                 \
        e.ReportException();                                        \
        Py_Error(Base::BaseExceptionEDError,str.c_str());      \
    }                                                               \
    ...
    {                                                               \
        Py_Error(Base::BaseExceptionEDError,e);                \
    }                                                               \
    catch(...)                                                      \
    {                                                               \
        Py_Error(Base::BaseExceptionEDError,"Unknown C++ exception"); \
