...
# include <climits>
# include <cstring>
# if defined (ED_OS_LINUX) || defined(ED_OS_CYGWIN) || defined(ED_OS_MACOSX) || defined(ED_OS_BSD)
# include <dirent.h>
# include <unistd.h>
# include <sys/stat.h>
...
#elif defined (ED_OS_LINUX) || defined(ED_OS_CYGWIN) || defined(ED_OS_MACOSX) || defined(ED_OS_BSD)
