...
// EDApplication Methods						// Methods structure
PyMethodDef Application::Methods[] = {
  ...
  {"getLocale",            (PyCFunction) Application::sGetLocale,     1,
   "getLocale() -> string\n\n"
   "Returns the locale currently used by ED"},
...
PyObject* Application::sActivateWorkbenchHandler(PyObject * /*self*/, PyObject *args,PyObject * /*kwd*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::BaseExceptionEdisonDesignerError, e.what());
        return 0;
    }
		...
		PyErr_SetString(Base::BaseExceptionEdisonDesignerError, "Unknown C++ exception raised in activateWorkbench");
        return 0;
    }
...
PyObject* Application::sAddIcon(PyObject * /*self*/, PyObject *args,PyObject * /*kwd*/)
{
    ...
    if (icon.isNull()) {
		PyErr_SetString(Base::BaseExceptionEdisonDesignerError, "Invalid icon added to application");
        return NULL;
    }
...
PyObject* Application::sAddCommand(PyObject * /*self*/, PyObject *args,PyObject * /*kwd*/)
{
    ...
    try {
		...
		PyErr_SetString(Base::BaseExceptionEdisonDesignerError, "Unknown C++ exception raised in Application::sAddCommand()");
        return 0;
    }
...
PyObject* Application::sRunCommand(PyObject * /*self*/, PyObject *args,PyObject * /*kwd*/)
{
    ...
    if (cmd) {
		...
		PyErr_Format(Base::BaseExceptionEdisonDesignerError, "No such command '%s'", pName);
        return 0;
    }
}
