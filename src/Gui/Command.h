 ...
 * This lightweigt class is the base class of all commands in ED. It represents the link between the ED
 ...
 * It contains also a lot of helper methods to make implementing commands for ED as easy as possible.
 *
 ...
 *  This class manage all available commands in ED. All 
