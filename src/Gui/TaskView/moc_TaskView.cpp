...
static const uint qt_meta_data_Gui__TaskView__TaskGroup[] = {
...
static const char qt_meta_stringdata_Gui__TaskView__TaskGroup[] = {
    "Gui::TaskView::TaskGroup\0"
};
...
const QMetaObjectExtraData Gui::TaskView::TaskGroup::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Gui::TaskView::TaskGroup::staticMetaObject = {
    { &QSint::ActionBox::staticMetaObject, qt_meta_stringdata_Gui__TaskView__TaskGroup,
      qt_meta_data_Gui__TaskView__TaskGroup, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Gui::TaskView::TaskGroup::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Gui__TaskView__TaskGroup))
        return static_cast<void*>(const_cast< TaskGroup*>(this));
    if (!strcmp(_clname, "TaskContent"))
        return static_cast< TaskContent*>(const_cast< TaskGroup*>(this));
    typedef QSint::ActionBox QMocSuperClass;
...
const QMetaObject Gui::TaskView::TaskBox::staticMetaObject = {
    { &QSint::ActionGroup::staticMetaObject, qt_meta_stringdata_Gui__TaskView__TaskBox,
...
void *Gui::TaskView::TaskBox::qt_metacast(const char *_clname)
{
    ...
    typedef QSint::ActionGroup QMocSuperClass;
    return QMocSuperClass::qt_metacast(_clname);
}
...
static const uint qt_meta_data_Gui__TaskView__TaskPanel[] = {
...
static const char qt_meta_stringdata_Gui__TaskView__TaskPanel[] = {
    "Gui::TaskView::TaskPanel\0"
};
...
const QMetaObjectExtraData Gui::TaskView::TaskPanel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Gui::TaskView::TaskPanel::staticMetaObject = {
    { &QSint::ActionPanel::staticMetaObject, qt_meta_stringdata_Gui__TaskView__TaskPanel,
      qt_meta_data_Gui__TaskView__TaskPanel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Gui::TaskView::TaskPanel::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Gui__TaskView__TaskPanel))
        return static_cast<void*>(const_cast< TaskPanel*>(this));
    typedef QSint::ActionPanel QMocSuperClass;
    return QMocSuperClass::qt_metacast(_clname);
}
