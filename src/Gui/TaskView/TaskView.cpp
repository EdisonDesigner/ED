...
#include "QSint/actionpanel/EDscheme.h"
#endif
...
{
    setScheme(iisEDTaskPanelScheme::defaultScheme());
}
    ...
    : QScrollArea(parent),ActiveDialog(0),ActiveCtrl(0)
{
    ...
    taskPanel->setScheme(iisEDTaskPanelScheme::defaultScheme());
#else
    ...
    taskPanel->setScheme(QSint::EDPanelScheme::defaultScheme());
#endif
...
{
#if defined (QSINT_ACTIONPANEL)
    static_cast<QSint::EDPanelScheme*>(QSint::EDPanelScheme::defaultScheme())->clearActionStyle();
    taskPanel->setScheme(QSint::EDPanelScheme::defaultScheme());
#endif
}
...
{
#if defined (QSINT_ACTIONPANEL)
    static_cast<QSint::EDPanelScheme*>(QSint::EDPanelScheme::defaultScheme())->restoreActionStyle();
    taskPanel->setScheme(QSint::EDPanelScheme::defaultScheme());
#endif
}
