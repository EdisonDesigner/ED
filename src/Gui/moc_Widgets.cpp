...
static const char qt_meta_stringdata_Gui__PropertyListEditor[] = {
    "Gui::PropertyListEditor\0\0newBlockCount\0"
...
void Gui::PropertyListEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        PropertyListEditor *_t = static_cast<PropertyListEditor *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData Gui::PropertyListEditor::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Gui::PropertyListEditor::staticMetaObject = {
    { &QPlainTextEdit::staticMetaObject, qt_meta_stringdata_Gui__PropertyListEditor,
      qt_meta_data_Gui__PropertyListEditor, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Gui::PropertyListEditor::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Gui__PropertyListEditor))
        return static_cast<void*>(const_cast< PropertyListEditor*>(this));
