...
DEF_STD_CMD(StdCmdEDWebsite);

StdCmdEDWebsite::StdCmdEDWebsite()
  :Command("Std_EDWebsite")
{
    sGroup        = QT_TR_NOOP("Help");
    sMenuText     = QT_TR_NOOP("ED Website");
    sToolTipText  = QT_TR_NOOP("The ED website");
    sWhatsThis    = "Std_EDWebsite";
    sStatusTip    = QT_TR_NOOP("ED Website");
    sPixmap       = "internet-web-browser";
    eType         = 0;
}

void StdCmdEDWebsite::activated(int iMsg)
{
...
DEF_STD_CMD(StdCmdEDUserHub);

StdCmdEDUserHub::StdCmdEDUserHub()
  :Command("Std_EDUserHub")
{
    sGroup        = QT_TR_NOOP("Help");
    sMenuText     = QT_TR_NOOP("Users documentation");
    sToolTipText  = QT_TR_NOOP("Documentation for users on the ED website");
    sWhatsThis    = "Std_EDUserHub";
    sStatusTip    = QT_TR_NOOP("Users documentation");
    sPixmap       = "internet-web-browser";
    eType         = 0;
}

void StdCmdEDUserHub::activated(int iMsg)
{
...
DEF_STD_CMD(StdCmdEDPowerUserHub);

StdCmdEDPowerUserHub::StdCmdEDPowerUserHub()
  :Command("Std_EDPowerUserHub")
{
    sGroup        = QT_TR_NOOP("Help");
    sMenuText     = QT_TR_NOOP("Python scripting documentation");
    sToolTipText  = QT_TR_NOOP("Python scripting documentation on the ED website");
    sWhatsThis    = "Std_EDPowerUserHub";
    sStatusTip    = QT_TR_NOOP("PowerUsers documentation");
    sPixmap       = "internet-web-browser";
    eType         = 0;
}

void StdCmdEDPowerUserHub::activated(int iMsg)
{
...
DEF_STD_CMD(StdCmdEDForum);

StdCmdEDForum::StdCmdEDForum()
  :Command("Std_EDForum")
{
    sGroup        = QT_TR_NOOP("Help");
    sMenuText     = QT_TR_NOOP("ED Forum");
    sToolTipText  = QT_TR_NOOP("The ED forum, where you can find help from other users");
    sWhatsThis    = "Std_EDForum";
    sStatusTip    = QT_TR_NOOP("The ED Forum");
    sPixmap       = "internet-web-browser";
    eType         = 0;
}

void StdCmdEDForum::activated(int iMsg)
{
...
DEF_STD_CMD(StdCmdEDFAQ);

StdCmdEDFAQ::StdCmdEDFAQ()
  :Command("Std_EDFAQ")
{
    sGroup        = QT_TR_NOOP("Help");
    sMenuText     = QT_TR_NOOP("ED FAQ");
    sToolTipText  = QT_TR_NOOP("Frequently Asked Questions on the ED website");
    sWhatsThis    = "Std_EDFAQ";
    sStatusTip    = QT_TR_NOOP("Frequently Asked Questions");
    sPixmap       = "internet-web-browser";
    eType         = 0;
}

void StdCmdEDFAQ::activated(int iMsg)
{
...
void StdCmdMeasurementSimple::activated(int iMsg)
{
    ...
    doCommand(Doc,"_f.P1 = ED.Vector(%f,%f,%f)",Sel[0].x,Sel[0].y,Sel[0].z);
    doCommand(Doc,"_f.P2 = ED.Vector(%f,%f,%f)",Sel[1].x,Sel[1].y,Sel[1].z);
    updateActive();
    commitCommand();
}
//===========================================================================
...
void CreateStdCommands(void)
{
    ...
    rcCmdMgr.addCommand(new StdCmdEDWebsite());
    rcCmdMgr.addCommand(new StdCmdEDUserHub());
    rcCmdMgr.addCommand(new StdCmdEDPowerUserHub());
    rcCmdMgr.addCommand(new StdCmdEDForum());
    rcCmdMgr.addCommand(new StdCmdEDFAQ());
