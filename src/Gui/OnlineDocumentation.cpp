...
QByteArray OnlineDocumentation::loadResource(const QString& filename) const
{
    ...
    if (fn == QLatin1String("favicon.ico")) {
        ...
        QString header = QString::fromLatin1(
            ...
            "<font color=\"#ffffff\" face=\"helvetica, arial\"><big><strong>EdisonDesigner Modules</strong></big></font></td></tr>"
            ""
        ...
        header.setContentType(QString::fromLatin1("text/html\r\n"
            ...
            "<tr bgcolor=\"#7799ee\">"
            "<td valign=bottom>&nbsp;<br>"
            "<font color=\"#ffffff\" face=\"helvetica, arial\">&nbsp;<br><big><big><strong>EdisonDesigner Documentation</strong></big></big></font></td>"
            "<td align=right valign=bottom>"
            "<font color=\"#ffffff\" face=\"helvetica, arial\">&nbsp;</font></td></tr></table>"
            "<p><p>"
...
QByteArray PythonOnlineHelp::loadResource(const QString& filename) const
{
    ...
    if (fn == QLatin1String("favicon.ico")) {
        ...
        QByteArray cmd =
            ...
            "\n"
            "class EdisonDesignerDoc(pydoc.HTMLDoc):\n"
            ...
            "\n"
            "pydoc.html=EdisonDesignerDoc()\n"
            "title='EdisonDesigner Python Modules Index'\n"
            "\n"
            ...
            "    'Built-in EdisonDesigner Modules', '#ffffff', '#ee77aa', contents))\n"
            "\n"
            "seen = {}\n"
            "for dir in sys.path:\n"
