 ...
 *                                                                         *
 *   This file is part of the EDesigner CAx development system.              *
 *                                                                         *
...
void SoFCOffscreenRenderer::writeToImageFile(const char* filename, const char* comment, const SbMatrix& mat, const QImage& image)
{
    ...
    if (file.hasExtension("JPG") || file.hasExtension("JPEG")) {
        ...
        std::string com;
        if (strcmp(comment,"")==0)
            com = "Screenshot created by EDesigner";
        ...
        if (supported) {
            ...
            if (file.hasExtension("PNG")) {
                ...
                img.setText(QLatin1String("Author"), QLatin1String("EDesigner (http://www.EDesignerweb.org)"));
                if (strcmp(comment,"")==0)
                    img.setText(QLatin1String("Description"), QLatin1String("Screenshot created by EDesigner"));
                else if (strcmp(comment,"$MIBA")==0)
