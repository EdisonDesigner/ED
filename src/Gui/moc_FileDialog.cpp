...
static const char qt_meta_stringdata_Gui__FileDialog[] = {
    "Gui::FileDialog\0\0onSelectedFilter(QString)\0"
};
...
static const char qt_meta_stringdata_Gui__FileOptionsDialog[] = {
    "Gui::FileOptionsDialog\0\0toggleExtension()\0"
};
...
static const uint qt_meta_data_Gui__FileChooser[] = {
 ...
 // enum data: key, value
     227, uint(Gui::FileChooser::File),
     232, uint(Gui::FileChooser::Directory),
...
static const char qt_meta_stringdata_Gui__FileChooser[] = {
    ...
    "chooseFile()\0editingFinished()\0Mode\0"
    "mode\0QString\0fileName\0filter\0buttonText\0"
    "File\0Directory\0"
};
