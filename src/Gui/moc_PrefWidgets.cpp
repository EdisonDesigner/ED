...
static const char qt_meta_stringdata_Gui__PrefQuantitySpinBox[] = {
    "Gui::PrefQuantitySpinBox\0QByteArray\0"
    "prefPath\0int\0historySize\0"
};
...
const QMetaObjectExtraData Gui::PrefQuantitySpinBox::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Gui::PrefQuantitySpinBox::staticMetaObject = {
    { &QuantitySpinBox::staticMetaObject, qt_meta_stringdata_Gui__PrefQuantitySpinBox,
      qt_meta_data_Gui__PrefQuantitySpinBox, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Gui::PrefQuantitySpinBox::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Gui__PrefQuantitySpinBox))
        return static_cast<void*>(const_cast< PrefQuantitySpinBox*>(this));
...
int Gui::PrefQuantitySpinBox::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_id < 0)
     ...
     if (_c == QMetaObject::ReadProperty) {
        ...
        case 1: *reinterpret_cast< int*>(_v) = historySize(); break;
        }
        _id -= 2;
    } else if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        ...
        case 1: setHistorySize(*reinterpret_cast< int*>(_v)); break;
        }
        _id -= 2;
    } else if (_c == QMetaObject::ResetProperty) {
        _id -= 2;
