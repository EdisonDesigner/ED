...
static const char qt_meta_stringdata_Gui__Dialog__DlgMacroExecuteImp[] = {
    ...
    "on_userMacroListBox_currentItemChanged(QTreeWidgetItem*)\0"
    "on_systemMacroListBox_currentItemChanged(QTreeWidgetItem*)\0"
    "index\0on_tabMacroWidget_currentChanged(int)\0"
};
...
void Gui::Dialog::DlgMacroExecuteImp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->on_userMacroListBox_currentItemChanged((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1]))); break;
        case 5: _t->on_systemMacroListBox_currentItemChanged((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1]))); break;
        case 6: _t->on_tabMacroWidget_currentChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
