...
static const char qt_meta_stringdata_SIM__Coin3D__Quarter__DragDropHandler[] = {
    "SIM::Coin3D::Quarter::DragDropHandler\0"
};
...
const QMetaObjectExtraData SIM::Coin3D::Quarter::DragDropHandler::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SIM::Coin3D::Quarter::DragDropHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SIM__Coin3D__Quarter__DragDropHandler,
      qt_meta_data_SIM__Coin3D__Quarter__DragDropHandler, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SIM::Coin3D::Quarter::DragDropHandler::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SIM__Coin3D__Quarter__DragDropHandler))
