...
void PythonStdout::init_type()
{
	...
	behaviors().doc("Redirection of stdout to EdisonDesigner's Python console window");
...
void OutputStdout::init_type()
{
	...
	behaviors().doc("Redirection of stdout to EdisonDesigner's output window");
    // you must have overwritten the virtual functions
    behaviors().supportRepr();
...
void PythonStdin::init_type()
{
	...
	behaviors().doc("Redirection of stdin to EdisonDesigner to open an input dialog");
    // you must have overwritten the virtual functions
    behaviors().supportRepr();
