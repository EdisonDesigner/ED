...
void PythonStdout::init_type()
{
    ...
    behaviors().doc("Redirection of stdout to ED's Python console window");
...
void OutputStdout::init_type()
{
    ...
    behaviors().doc("Redirection of stdout to ED's output window");
    // you must have overwritten the virtual functions
    behaviors().supportRepr();
...
void PythonStdin::init_type()
{
    ...
    behaviors().doc("Redirection of stdin to ED to open an input dialog");
    // you must have overwritten the virtual functions
    behaviors().supportRepr();
