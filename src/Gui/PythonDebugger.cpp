...
PythonDebugModule::PythonDebugModule()
  : Py::ExtensionModule<PythonDebugModule>("EDDbg")
{
    ...
    initialize( "The ED Python debug module" );
...
void PythonDebugStdout::init_type()
{
    ...
    behaviors().doc("Redirection of stdout to ED's Python debugger window");
...
void PythonDebugStderr::init_type()
{
    ...
    behaviors().doc("Redirection of stderr to ED's Python debugger window");
    // you must have overwritten the virtual functions
    behaviors().supportRepr();
