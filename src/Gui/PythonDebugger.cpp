...
PythonDebugModule::PythonDebugModule()
  : Py::ExtensionModule<PythonDebugModule>("EdisonDesignerDbg")
{
    ...
    initialize( "The EdisonDesigner Python debug module" );
...
void PythonDebugStdout::init_type()
{
	...
	behaviors().doc("Redirection of stdout to EdisonDesigner's Python debugger window");
...
void PythonDebugStderr::init_type()
{
	...
	behaviors().doc("Redirection of stderr to EdisonDesigner's Python debugger window");
    // you must have overwritten the virtual functions
    behaviors().supportRepr();
