...
const char* MinimumActionPanelED =
...
EDPanelScheme::EDPanelScheme() : ActionPanelScheme()
{
#if defined(Q_OS_WIN32)
    ActionPanelScheme* panelStyle = WinXPPanelScheme2::defaultScheme();

    actionStyle = QString(ActionPanelED);
    ...
    minimumStyle = QString(MinimumActionPanelED);
...
void EDPanelScheme::clearActionStyle()
{
...
void EDPanelScheme::restoreActionStyle()
{
