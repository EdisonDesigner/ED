...
#ifndef EDTASKPANELSCHEME_H
#define EDTASKPANELSCHEME_H
...
class QSINT_EXPORT EDPanelScheme : public ActionPanelScheme
{
public:
    explicit EDPanelScheme();

    static ActionPanelScheme* defaultScheme()
    {
        static EDPanelScheme scheme;
        return &scheme;
    }
