 ...
 * \a Gui::CommandBase and \a Gui::Action that represent the link between Qt's QAction world and the ED's command  world. 
 *
 ...
 * };
 * \endcode
 * An instance of \a OpenCommand must be created and added to the \ref Gui::CommandManager to make the class known to ED.
...
void Command::invoke(int i)
{
    ...
    try {
        ...
        e.ReportException();
        // Pop-up a dialog for ED-specific exceptions
