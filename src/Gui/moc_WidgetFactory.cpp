...
static const char qt_meta_stringdata_Gui__Dialog__PreferencePagePython[] = {
    "Gui::Dialog::PreferencePagePython\0"
};
...
const QMetaObjectExtraData Gui::Dialog::PreferencePagePython::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Gui::Dialog::PreferencePagePython::staticMetaObject = {
    { &PreferencePage::staticMetaObject, qt_meta_stringdata_Gui__Dialog__PreferencePagePython,
      qt_meta_data_Gui__Dialog__PreferencePagePython, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Gui::Dialog::PreferencePagePython::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Gui__Dialog__PreferencePagePython))
        return static_cast<void*>(const_cast< PreferencePagePython*>(this));
