...
#include "iisEDscheme.h"
#include <QApplication>
#include <QStyle>


iisEDTaskPanelScheme* iisEDTaskPanelScheme::myDefaultXPScheme = 0;

iisEDTaskPanelScheme::iisEDTaskPanelScheme(QObject *parent)
...
iisEDTaskPanelScheme::~iisEDTaskPanelScheme()
{

}

iisTaskPanelScheme* iisEDTaskPanelScheme::defaultScheme()	
{ 
	if (!myDefaultXPScheme)
		myDefaultXPScheme = new iisEDTaskPanelScheme();

	return myDefaultXPScheme; 
}

QPixmap iisEDTaskPanelScheme::drawFoldIcon(const QPalette& p) const
{
