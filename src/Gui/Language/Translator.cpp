...
/** \defgroup i18n Internationalization with ED
 *  \ingroup GUI
 *
 * The internationalization of ED makes heavy use of the internationalization
 * support of Qt. For more details refer to your Qt documentation.
 * 
 * \section stepbystep Step by step
 * To integrate a new language into ED or one of its application modules
 ...
 * The .qm file should now be integrated into the GUI library (either of ED
