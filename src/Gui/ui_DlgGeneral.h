...
public:
    ...
    void retranslateUi(QWidget *Gui__Dialog__DlgGeneral)
    {
        ...
        tiledBackground->setText(QApplication::translate("Gui::Dialog::DlgGeneral", "Enable tiled background", 0, QApplication::UnicodeUTF8));
        styleSheetLabel->setText(QApplication::translate("Gui::Dialog::DlgGeneral", "Style sheet:", 0, QApplication::UnicodeUTF8));
