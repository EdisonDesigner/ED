...
static const char qt_meta_stringdata_Gui__Dialog__IconFolders[] = {
    "Gui::Dialog::IconFolders\0\0addFolder()\0"
    "removeFolder()\0"
};
...
void Gui::Dialog::IconFolders::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        IconFolders *_t = static_cast<IconFolders *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData Gui::Dialog::IconFolders::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Gui::Dialog::IconFolders::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Gui__Dialog__IconFolders,
      qt_meta_data_Gui__Dialog__IconFolders, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Gui::Dialog::IconFolders::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Gui__Dialog__IconFolders))
        return static_cast<void*>(const_cast< IconFolders*>(this));
    return QDialog::qt_metacast(_clname);
}
