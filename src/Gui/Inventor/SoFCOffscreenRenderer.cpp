    ...
    if (file.hasExtension("JPG") || file.hasExtension("JPEG")) {
        ...
        if (supported) {
            ...
            if (file.hasExtension("PNG")) {
                ...
                img.setText(QLatin1String("Author"), QLatin1String("ED (http://www.freecadweb.org)"));
                if (strcmp(comment,"")==0)
                    img.setText(QLatin1String("Description"), QLatin1String("Screenshot created by ED"));
                else if (strcmp(comment,"$MIBA")==0)
