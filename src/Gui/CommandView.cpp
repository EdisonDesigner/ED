...
{
    sGroup        = QT_TR_NOOP("Standard-View");
    sMenuText     = QT_TR_NOOP("ED-VR");
    sToolTipText  = QT_TR_NOOP("Extend the ED 3D Window to a Oculus Rift");
    sWhatsThis    = "Std_ViewVR";
    sStatusTip    = QT_TR_NOOP("Extend the ED 3D Window to a Oculus Rift");
    eType         = Alter3DView;
}
