...
[EDVersionMajor,EDVersionMinor,EDVersionBuild,EDVersionDisDa,dummy] = open("../Version.h",'r').readlines()

# increasing build number
BuildNumber = int(EDVersionBuild[23:-1]) +1

# writing new Version.h File
open("../Version.h",'w').writelines([EDVersionMajor,EDVersionMinor,EDVersionBuild[:23]+`BuildNumber`+'\n',EDVersionDisDa[:23]+ '"'+time.asctime()+'"'])
