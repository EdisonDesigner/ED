...
PyObject * @self.export.Name@::staticCallback_get@i.Name@ (PyObject *self, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::BaseExceptionEdisonDesignerError, "Unknown exception while reading attribute '@i.Name@' of object '@self.export.Twin@'");
        return NULL;
    }
}
...
-
        ...
        PyErr_SetString(Base::BaseExceptionEdisonDesignerError, "Unknown exception while writing attribute '@i.Name@' of object '@self.export.Twin@'");
        return -1;
    }
}
-
