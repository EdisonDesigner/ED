...
void TopoShape::exportStep(const char *filename) const
{
    try {
        ...
        makeHeader.SetAuthorValue (1, new TCollection_HAsciiString("ED"));
        makeHeader.SetOrganizationValue (1, new TCollection_HAsciiString("ED"));
        makeHeader.SetOriginatingSystem(new TCollection_HAsciiString("ED"));
        makeHeader.SetDescriptionValue(1, new TCollection_HAsciiString("ED Model"));
