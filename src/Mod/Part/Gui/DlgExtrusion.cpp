...
void DlgExtrusion::apply()
{
    ...
    for (QList<QTreeWidgetItem *>::iterator it = items.begin(); it != items.end(); ++it) {
        ...
        QString code = QString::fromLatin1(
            "ED.getDocument(\"%1\").addObject(\"%2\",\"%3\")\n"
            "ED.getDocument(\"%1\").%3.Base = ED.getDocument(\"%1\").%4\n"
            "ED.getDocument(\"%1\").%3.Dir = (%5,%6,%7)\n"
            "ED.getDocument(\"%1\").%3.Solid = (%8)\n"
            "ED.getDocument(\"%1\").%3.TaperAngle = (%9)\n"
            "EDGui.getDocument(\"%1\").%4.Visibility = False\n"
            "ED.getDocument(\"%1\").%3.Label = '%10'\n")
