...
public:
    ...
    QDoubleSpinBox *dirZ;
    QLabel *label_5;
    Gui::QuantitySpinBox *dirLen;
    QCheckBox *makeSolid;
    QHBoxLayout *horizontalLayout;
    QLabel *label;
    Gui::QuantitySpinBox *taperAngle;
    ...
    void setupUi(QDialog *PartGui__DlgExtrusion)
    {
        ...
        PartGui__DlgExtrusion->resize(260, 545);
        ...
        dirLen = new Gui::QuantitySpinBox(groupBox_2);
        ...
        dirLen->setProperty("unit", QVariant(QString::fromUtf8("mm")));
        ...
        taperAngle = new Gui::QuantitySpinBox(PartGui__DlgExtrusion);
        taperAngle->setObjectName(QString::fromUtf8("taperAngle"));
        taperAngle->setProperty("unit", QVariant(QString::fromUtf8("deg")));
        ...
        gridLayout_3->addWidget(statusLabel, 4, 0, 1, 1);
