...
void DlgRevolution::accept()
{
    ...
    for (QList<QTreeWidgetItem *>::iterator it = items.begin(); it != items.end(); ++it) {
        ...
        QString code = QString::fromLatin1(
            "ED.ActiveDocument.addObject(\"%1\",\"%2\")\n"
            "ED.ActiveDocument.%2.Source = ED.ActiveDocument.%3\n"
            "ED.ActiveDocument.%2.Axis = (%4,%5,%6)\n"
            "ED.ActiveDocument.%2.Base = (%7,%8,%9)\n"
            "ED.ActiveDocument.%2.Angle = %10\n"
            "ED.ActiveDocument.%2.Solid = %11\n"
            "EDGui.ActiveDocument.%3.Visibility = False\n")
