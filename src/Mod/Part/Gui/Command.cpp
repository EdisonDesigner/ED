...
void CmdPartBox2::activated(int iMsg)
{
    ...
    doCommand(Doc,"from ED import Base");
...
void CmdPartRuledSurface::activated(int iMsg)
{
    ...
    doCommand(Doc, "ED.ActiveDocument.addObject('Part::RuledSurface', 'Ruled Surface')");
    doCommand(Doc, "ED.ActiveDocument.ActiveObject.Curve1=(ED.ActiveDocument.%s,['%s'])"
                 ,obj1.c_str(), link1.c_str());
    doCommand(Doc, "ED.ActiveDocument.ActiveObject.Curve2=(ED.ActiveDocument.%s,['%s'])"
