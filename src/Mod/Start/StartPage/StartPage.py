...
from .TranslationTexts import (text01, text02, text03, text04, text05, text06,
                              ...
                              text43, text45, text46, text47, text48,
                              text49, text50, text51,
                              text56, text57, text58, text59,
                              text61, text62, text63, text65, text66,
                              text67, text68, text70, text71)
...
def getInfo(filename):
    ...
    if os.path.exists(filename):
        ...
        if os.path.splitext(filename)[1].upper() in [".FCSTD"]:
            ...
            print ("not a EdisonDesigner file: "+os.path.splitext(filename)[1].upper())
    else:
        html += "<p>" + text41 + "</p>"
    return html
    ...
    for i in range(4):
        if i < ct:
            ...
            if os.path.exists(mr):
                ...
                html += '<li>'
                if mr[-5:].upper() == "FCSTD":
                    html += '<img src="images/EdisonDesigner-doc.png" style="width: 16px">&nbsp;'
                else:
