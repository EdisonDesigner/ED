...
import ED, os, sys, unittest, Part, Sketcher
App = ED

def CreateBoxSketchSet(SketchFeature):
	SketchFeature.addGeometry(Part.Line(ED.Vector(-99.230339,36.960674,0),ED.Vector(69.432587,36.960674,0)))
	SketchFeature.addGeometry(Part.Line(ED.Vector(69.432587,36.960674,0),ED.Vector(69.432587,-53.196629,0)))
	SketchFeature.addGeometry(Part.Line(ED.Vector(69.432587,-53.196629,0),ED.Vector(-99.230339,-53.196629,0)))
	SketchFeature.addGeometry(Part.Line(ED.Vector(-99.230339,-53.196629,0),ED.Vector(-99.230339,36.960674,0)))
	# add the constraints
...
#---------------------------------------------------------------------------
# define the test cases to test the ED Sketcher module
#---------------------------------------------------------------------------


class SketcherSolverTestCases(unittest.TestCase):
	def setUp(self):
		self.Doc = ED.newDocument("SketchSolverTest")
	...
	def tearDown(self):
		#closing doc
		ED.closeDocument("SketchSolverTest")
