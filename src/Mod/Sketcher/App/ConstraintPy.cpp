...
PyObject * ConstraintPy::staticCallback_getFirst (PyObject *self, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::BaseExceptionEDError, "Unknown exception while reading attribute 'First' of object 'Constraint'");
        return NULL;
    }
}
...
int ConstraintPy::staticCallback_setFirst (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<ConstraintPy*>(self)->setFirst(Py::Int(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
    } catch (...) {
        PyErr_SetString(Base::BaseExceptionEDError, "Unknown exception while writing attribute 'First' of object 'Constraint'");
        return -1;
    }
}
...
PyObject * ConstraintPy::staticCallback_getSecond (PyObject *self, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::BaseExceptionEDError, "Unknown exception while reading attribute 'Second' of object 'Constraint'");
        return NULL;
    }
}
...
int ConstraintPy::staticCallback_setSecond (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<ConstraintPy*>(self)->setSecond(Py::Int(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
    } catch (...) {
        PyErr_SetString(Base::BaseExceptionEDError, "Unknown exception while writing attribute 'Second' of object 'Constraint'");
        return -1;
    }
}
...
PyObject * ConstraintPy::staticCallback_getName (PyObject *self, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::BaseExceptionEDError, "Unknown exception while reading attribute 'Name' of object 'Constraint'");
        return NULL;
    }
}
...
int ConstraintPy::staticCallback_setName (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::BaseExceptionEDError, "Unknown exception while writing attribute 'Name' of object 'Constraint'");
        return -1;
    }
}
