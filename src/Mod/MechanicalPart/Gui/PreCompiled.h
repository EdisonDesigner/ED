...
#ifdef ED_OS_WIN32
# define MechanicalPartAppExport __declspec(dllimport)
# define MechanicalPartGuiExport __declspec(dllexport)
#else // for Linux
# define MechanicalPartAppExport
# define MechanicalPartGuiExport
#endif
