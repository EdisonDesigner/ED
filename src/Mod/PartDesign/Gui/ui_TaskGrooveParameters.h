...
public:
    ...
    QLabel *label;
    Gui::QuantitySpinBox *grooveAngle;
    ...
    void setupUi(QWidget *PartDesignGui__TaskGrooveParameters)
    {
        ...
        grooveAngle = new Gui::QuantitySpinBox(PartDesignGui__TaskGrooveParameters);
        grooveAngle->setObjectName(QString::fromUtf8("grooveAngle"));
        grooveAngle->setProperty("unit", QVariant(QString::fromUtf8("deg")));
        grooveAngle->setMinimum(0);
        grooveAngle->setMaximum(360);
        grooveAngle->setSingleStep(10);
        grooveAngle->setValue(360);

        horizontalLayout_3->addWidget(grooveAngle);
