...
static const char qt_meta_stringdata_PartDesignGui__TaskPolarPatternParameters[] = {
    ...
    "\0onUpdateViewTimer()\0num\0onAxisChanged(int)\0"
    "on\0onCheckReverse(bool)\0a\0onAngle(double)\0"
    "n\0onOccurrences(uint)\0onUpdateView(bool)\0"
};
...
void PartDesignGui::TaskPolarPatternParameters::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onCheckReverse((*reinterpret_cast< const bool(*)>(_a[1]))); break;
        case 3: _t->onAngle((*reinterpret_cast< const double(*)>(_a[1]))); break;
        case 4: _t->onOccurrences((*reinterpret_cast< const uint(*)>(_a[1]))); break;
        case 5: _t->onUpdateView((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
