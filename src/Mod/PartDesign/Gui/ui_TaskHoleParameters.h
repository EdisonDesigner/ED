...
public:
    ...
    QLabel *label;
    Gui::QuantitySpinBox *doubleSpinBox;
    ...
    void setupUi(QWidget *PartDesignGui__TaskHoleParameters)
    {
        ...
        doubleSpinBox = new Gui::QuantitySpinBox(PartDesignGui__TaskHoleParameters);
        doubleSpinBox->setObjectName(QString::fromUtf8("doubleSpinBox"));
        doubleSpinBox->setProperty("unit", QVariant(QString::fromUtf8("mm")));
