...
import ED, EDGui, Part, Draft, math, MeshPart, Mesh
...
def compute():    
    ...
    try:
        ...
        ED.Console.PrintError("Wrong input! Only numbers allowed...\n")
    ...
    #Base circle
    baseCircle=ED.ActiveDocument.addObject("Part::FeaturePython","BaseCircle")
    ...
    #Root circle
    rootCircle=ED.ActiveDocument.addObject("Part::FeaturePython","RootCircle")
    ...
    #Addendum circle
    addendumCircle=ED.ActiveDocument.addObject("Part::FeaturePython","AddendumCircle")
    ...
    #Pitch circle
    pitchCircle=ED.ActiveDocument.addObject("Part::FeaturePython","PitchCircle")
...
#************ Drawing rigth sides of teeth   
    ...
    for angle in range(1,N+1,1):
        involuteobj = ED.ActiveDocument.addObject("Part::Feature","InvoluteL"+str(angle))
...
#    ED.ActiveDocument.addObject("Part::Feature","CutInv").Shape=cut
...
#************ Drawing left sides of teeth
    for angle in range(1,N+1,1):
        involuteobj = ED.ActiveDocument.addObject("Part::Feature","InvoluteR"+str(angle))
        involutee.insert(0,(0,0,0))
        involuteshape = Part.makePolygon(involutee)
        involuteobj.Shape=involuteshape
        involutee=[]
...
#************ Forming teeth
    ...
    cutCircle=ED.ActiveDocument.addObject("Part::FeaturePython","CutCircle")
