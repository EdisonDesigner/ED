...
class WizardShaftGui:    
    def Activated(self):
        ...
        WizardShaftDlg = TaskWizardShaft(ED.ActiveDocument)
        EDGui.Control.showDialog(WizardShaftDlg)
        
    def GetResources(self):
        IconPath = ED.ConfigGet("AppHomePath") + "Mod/PartDesign/WizardShaft/WizardShaft.svg"
        MenuText = 'Shaft design wizard...'
        ToolTip  = 'Start the shaft design wizard'
        return {'Pixmap' : IconPath, 'MenuText': MenuText, 'ToolTip': ToolTip}

    def IsActive(self):
        return ED.ActiveDocument != None
...
EDGui.addCommand('PartDesign_WizardShaft', WizardShaftGui())
EDGui.addCommand('PartDesign_WizardShaftCallBack', WizardShaftGuiCallback())
