...
import ED # just for debug printing to console...
import numpy as np
...
class SegmentFunction:
    ...
    def output(self):
        ED.Console.PrintMessage(self.name + " = ")
        for i in range(len(self.segments)):
            ED.Console.PrintMessage(self.segments[i].asString())
...
class TranslationFunction:
    ...
    def __init__(self,  f,  E,  d,  tangents,  translations):
        ...
        #ED.Console.PrintMessage(A)
        #ED.Console.PrintMessage(" * x = ")
        #ED.Console.PrintMessage(b)
        #ED.Console.PrintMessage("\n")
    ...
    def evaluate(self, maxX, pointsX):
        ...
        for xval in sorted(xvals):
            if xval in divs:
                ...
                ED.Console.PrintMessage("Interval %u: %f to %f, I_i: %f, C_i0: %f, C_i1: %f\n" % (i,  begin, length,  I_i,  C_i0,  C_i1))           
