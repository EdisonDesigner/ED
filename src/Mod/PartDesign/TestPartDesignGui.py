...
import ED, EDGui, os, sys, unittest, PartDesign, PartDesignGui


#---------------------------------------------------------------------------
# define the test cases to test the ED PartDesign module
#---------------------------------------------------------------------------


#class PartDesignGuiTestCases(unittest.TestCase):
#	def setUp(self):
#		self.Doc = ED.newDocument("SketchGuiTest")
#
...
#	def tearDown(self):
#		#closing doc
#		ED.closeDocument("SketchGuiTest")
