...
def makeInvoluteGear(name):
    ...
    obj = ED.ActiveDocument.addObject("Part::Part2DObjectPython",name)
    _InvoluteGear(obj)
    if ED.GuiUp:
...
class _CommandInvoluteGear:
    ...
    def Activated(self):
        ...
        ED.ActiveDocument.openTransaction("Create involute gear")
        EDGui.addModule("InvoluteGearFeature")
        EDGui.doCommand("InvoluteGearFeature.makeInvoluteGear('InvoluteGear')")
        EDGui.doCommand("Gui.activeDocument().setEdit(App.ActiveDocument.ActiveObject.Name,0)")
...
class _ViewProviderInvoluteGear:
    ...
    def setEdit(self,vobj,mode):
        ...
        taskd.update()
        EDGui.Control.showDialog(taskd)
        return True
...
class _InvoluteGearTaskPanel:
    ...
    def __init__(self,obj,mode):
        ...
        self.form=EDGui.PySideUic.loadUi(ED.getHomePath() + "Mod/PartDesign/InvoluteGearFeature.ui")
        ...
        if mode == 0: # fresh created
            ...
            ED.Gui.SendMsgToActiveView("ViewFit")
    ...
    def accept(self):
        ...
        self.transferTo()
        ED.ActiveDocument.recompute()
        EDGui.ActiveDocument.resetEdit()
...
if ED.GuiUp:
    EDGui.addCommand('PartDesign_InvoluteGear',_CommandInvoluteGear())
