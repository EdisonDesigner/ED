...
private:
    ...
    Py::Object createBox(const Py::Tuple& args)
    {
        ...
        if (!mesh) {
            throw Py::Exception(Base::BaseExceptionEdisonDesignerError, "Creation of box failed");
        }
    ...
    Py::Object createSphere(const Py::Tuple& args)
    {
        ...
        if (!mesh) {
            throw Py::Exception(Base::BaseExceptionEdisonDesignerError, "Creation of sphere failed");
        }
        return Py::asObject(new MeshPy(mesh));
    }
    Py::Object createEllipsoid(const Py::Tuple& args)
    {
        ...
        if (!mesh) {
            throw Py::Exception(Base::BaseExceptionEdisonDesignerError, "Creation of ellipsoid failed");
        }
        return Py::asObject(new MeshPy(mesh));
    }
    Py::Object createCylinder(const Py::Tuple& args)
    {
        ...
        if (!mesh) {
            throw Py::Exception(Base::BaseExceptionEdisonDesignerError, "Creation of cylinder failed");
        }
        return Py::asObject(new MeshPy(mesh));
    }
    Py::Object createCone(const Py::Tuple& args)
    {
        ...
        if (!mesh) {
            throw Py::Exception(Base::BaseExceptionEdisonDesignerError, "Creation of cone failed");
        }
        return Py::asObject(new MeshPy(mesh));
    }
    Py::Object createTorus(const Py::Tuple& args)
    {
        ...
        if (!mesh) {
            throw Py::Exception(Base::BaseExceptionEdisonDesignerError, "Creation of torus failed");
        }
        return Py::asObject(new MeshPy(mesh));
    }
