...
bool MeshOutput::SaveOBJ (std::ostream &out) const
{
    ...
    // Header
    out << "# Created by EdisonDesigner <http://www.freecadweb.org>" << std::endl;
    out.precision(6);
...
bool MeshOutput::SaveBinaryPLY (std::ostream &out) const
{
    ...
    out << "ply" << std::endl
        ...
        << "comment Created by EdisonDesigner <http://www.freecadweb.org>" << std::endl
...
bool MeshOutput::SaveInventor (std::ostream &rstrOut) const
{
    ...
    builder.addInfo("Created by EdisonDesigner <http://www.freecadweb.org>");
...
bool MeshOutput::SaveX3D (std::ostream &out) const
{
    ...
    out << "  <head>" << std::endl
        << "    <meta name=\"generator\" content=\"EdisonDesigner\"/>" << std::endl
...
bool MeshOutput::SaveVRML (std::ostream &rstrOut) const
{
    ...
    rstrOut << "WorldInfo {\n"
            ...
            << "  info [\"Created by EdisonDesigner\"\n"
