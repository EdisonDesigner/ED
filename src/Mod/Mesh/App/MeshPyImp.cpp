...
PyObject*  MeshPy::addFacet(PyObject *args)
{
    ...
    PyErr_SetString(Base::BaseExceptionEdisonDesignerError, "set 9 floats or three vectors");
    return 0;
}
...
PyObject*  MeshPy::addFacets(PyObject *args)
{
            ...
            if ((*it).isType(vFType)) {
                ...
                if (seq.size() == 3) {
                    if (PyFloat_Check(seq[0].ptr())) {
                        ...
                        PyErr_SetString(Base::BaseExceptionEdisonDesignerError, "expect a sequence of floats or Vector");
                        return NULL;
                    }
    ...
    PyErr_SetString(Base::BaseExceptionEdisonDesignerError, "either expect\n"
    ...
    if (PyList_Check(pcObj)) {
        ...
        for (int i = 0; i < PyList_Size(pcObj); i++) {
            ...
            if (PyInt_Check(idx)){
                ...
                Py_Error(Base::BaseExceptionEdisonDesignerError, "list of integers needed");
            }
        }
