...
public:
    ...
    void setupUi(QWidget *MeshGui__Segmentation)
    {
        ...
        radCyl = new Gui::QuantitySpinBox(groupBoxCyl);
        radCyl->setObjectName(QString::fromUtf8("radCyl"));
        radCyl->setProperty("unit", QVariant(QString::fromUtf8("mm")));
        ...
        radSph = new Gui::QuantitySpinBox(groupBoxSph);
        radSph->setObjectName(QString::fromUtf8("radSph"));
        radSph->setProperty("unit", QVariant(QString::fromUtf8("mm")));
