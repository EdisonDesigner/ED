...
public:
    ...
    void setupUi(QDialog *MeshGui__DlgRegularSolid)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/icons/RegularSolids/Mesh_Cube.svg"), QSize(), QIcon::Normal, QIcon::Off);
        comboBox1->addItem(icon, QString());
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons/RegularSolids/Mesh_Cylinder.svg"), QSize(), QIcon::Normal, QIcon::Off);
        comboBox1->addItem(icon1, QString());
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/RegularSolids/Mesh_Cone.svg"), QSize(), QIcon::Normal, QIcon::Off);
        comboBox1->addItem(icon2, QString());
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/icons/RegularSolids/Mesh_Sphere.svg"), QSize(), QIcon::Normal, QIcon::Off);
        comboBox1->addItem(icon3, QString());
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/icons/RegularSolids/Mesh_Ellipsoid.svg"), QSize(), QIcon::Normal, QIcon::Off);
        comboBox1->addItem(icon4, QString());
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icons/RegularSolids/Mesh_Torus.svg"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    void retranslateUi(QDialog *MeshGui__DlgRegularSolid)
    {
        ...
        comboBox1->setItemText(0, QApplication::translate("MeshGui::DlgRegularSolid", "Cube", 0, QApplication::UnicodeUTF8));
        comboBox1->setItemText(1, QApplication::translate("MeshGui::DlgRegularSolid", "Cylinder", 0, QApplication::UnicodeUTF8));
        comboBox1->setItemText(2, QApplication::translate("MeshGui::DlgRegularSolid", "Cone", 0, QApplication::UnicodeUTF8));
        comboBox1->setItemText(3, QApplication::translate("MeshGui::DlgRegularSolid", "Sphere", 0, QApplication::UnicodeUTF8));
        comboBox1->setItemText(4, QApplication::translate("MeshGui::DlgRegularSolid", "Ellipsoid", 0, QApplication::UnicodeUTF8));
        comboBox1->setItemText(5, QApplication::translate("MeshGui::DlgRegularSolid", "Torus", 0, QApplication::UnicodeUTF8));
