...
static const char qt_meta_stringdata_MeshGui__MeshFillHole[] = {
    "MeshGui::MeshFillHole\0\0finishEditing()\0"
    "closeBridge()\0"
};
...
void MeshGui::MeshFillHole::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        MeshFillHole *_t = static_cast<MeshFillHole *>(_o);
        switch (_id) {
        case 0: _t->finishEditing(); break;
...
const QMetaObjectExtraData MeshGui::MeshFillHole::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MeshGui::MeshFillHole::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MeshGui__MeshFillHole,
      qt_meta_data_MeshGui__MeshFillHole, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MeshGui::MeshFillHole::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MeshGui__MeshFillHole))
        return static_cast<void*>(const_cast< MeshFillHole*>(this));
    return QObject::qt_metacast(_clname);
}
