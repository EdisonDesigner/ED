...
class ConstraintSelectionObserver:
     def __init__(self, selectionGate, parseSelectionFunction,
          ...
          EDGui.Selection.addSelectionGate( selectionGate )
...
class SelectionRecord:
    def __init__(self, docName, objName, sub):
        self.Document = ED.getDocument(docName)
...
class ConstraintObjectProxy:
    ...
    def callSolveConstraints(self):
        ...
        if preferences.GetBool('useCache', False):
            ...
            solverCache = None
        solveConstraints( ED.ActiveDocument, cache = solverCache )
...
class SelectConstraintObjectsCommand:
    def Activated(self):
        constraintObj = EDGui.Selection.getSelectionEx()[0].Object
        obj1Name = constraintObj.Object1
        obj2Name = constraintObj.Object2
        EDGui.Selection.addSelection( ED.ActiveDocument.getObject(obj1Name) )
        EDGui.Selection.addSelection( ED.ActiveDocument.getObject(obj2Name) )
    def GetResources(self):
        return { 'MenuText': 'Select Objects' }
if ED.GuiUp:
    EDGui.addCommand('selectConstraintObjects', SelectConstraintObjectsCommand())
...
class SelectConstraintElementsCommand:
    def Activated(self):
        ...
        obj1Name = constraintObj.Object1
        obj2Name = constraintObj.Object2
        EDGui.Selection.addSelection( ED.ActiveDocument.getObject(obj1Name), constraintObj.SubElement1 )
        EDGui.Selection.addSelection( ED.ActiveDocument.getObject(obj2Name), constraintObj.SubElement2 )
    def GetResources(self):
        return { 'MenuText': 'Select Object Elements' }
if ED.GuiUp:
    EDGui.addCommand('selectConstraintElements', SelectConstraintElementsCommand())
