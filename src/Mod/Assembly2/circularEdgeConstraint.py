...
%s'''  % printSelection(selection)
    ...
    #EDGui.Selection.addSelection(c)
    return c
...
EDGui.addCommand('addCircularEdgeConstraint', CircularEdgeConstraintCommand())
...
EDGui.addCommand('redefineCircularEdgeConstraint', RedefineCircularEdgeConstraintCommand())


class FlipLastConstraintsDirectionCommand:
    def Activated(self):
        constraints = [ obj for obj in ED.ActiveDocument.Objects
...
EDGui.addCommand('flipLastConstraintsDirection', FlipLastConstraintsDirectionCommand())
...
EDGui.addCommand('lockLastConstraintsRotation', LockRotationOfLastConstraintAddedCommand())
