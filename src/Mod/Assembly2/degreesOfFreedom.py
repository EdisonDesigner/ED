...
if __name__ == '__main__':
    ...
    print('creating test EdisonDesigner document, constraining a single Cube')
    import FreeCAD as ED
    import Part
    ED.newDocument("testDoc")
    #ED.setActiveDocument("box")
    #ED.ActiveDocument = ED.getDocument("box")
    objName = "box"
    box = ED.ActiveDocument.addObject("Part::FeaturePython", objName)
    ...
    vM = VariableManager(ED.ActiveDocument)
    print(vM.X)
