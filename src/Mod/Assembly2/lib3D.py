...
def quaternion(theta, u_x, u_y, u_z ):
    ...
    returns q_1, q_2, q_3, q_0 as to match EdisonDesigners, if wikipedias naming is used'''
...
if __name__ == '__main__':
    ...
    print('\nRotations\n-----------\n')
    rotationTests = ( #EdisonDesigner Q, EdisonDesigner Q euler angles
    ...
    for Q, eulerAngles in rotationTests:
        print('EdisonDesigner Q : \t%s' % str(Q) )
        print('quaternion (Q) to euler angles:')
        print('  EdisonDesigner  \t%s' % str(eulerAngles) )
